...
{
	/**
	Implementation of an arithmetic encoder using integer arithmetics.

    @param	intervalsMap: map generated by 'createIntervals'
    		TREd: image to be encoded
   	@return a string corresponding to the binary representation of the encoder's output
	*/
	std::string outbuff;
...
{
	/**
	Implementation of an arithmetic decoder using integer numbers.

    @param	encoded: a string corresponding to the binary representation of the encoder's output
    		intervalsMap: map generated by 'createIntervals'
    		size of of the output
